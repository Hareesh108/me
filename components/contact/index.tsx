...
export default function ContactPage() {
  return (
    <div className="max-w-screen-lg mt-6 md:mt-10 mb-5 mx-4 lg:mx-auto rounded-xl bg-muted dark:bg-white/10 backdrop-blur-md border border-white/20 shadow-lg">
